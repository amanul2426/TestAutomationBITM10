...
public class DP_LoginTest2 {
    ...
    public static void login_valid_TC_001(String DP_Email,String DP_Pass) throws InterruptedException {
    ...
    public Object [][] data2(){
        ...
        //Data set 1
        data2 [0][0]="user101@gmail.com";
        data2 [0][1]="123456";

        //Data set 2
        data2 [1][0]="user1@bd.com";
        data2 [1][1]="123456";
